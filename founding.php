            ...
            <section class="s-content">
                <div class="row narrow">
                    <div class="col-full s-content__header" data-aos="fade-up">
                        <h2 style="margin-bottom: -5px; margin-top:-20px">พบเจอของหาย</h2>
                        <p style="color:lightsteelblue;">I'm looking for my lost things</p>
                        <hr style="margin-top: -15px">
                        <form action="founding.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="size" value="1000000"> 
                            <p style="font-size: 20px">เจออะไรมา ?</p>
                            ...
                            <br>
                            <p style="font-size: 20px">สถานที่เจอ</p>
